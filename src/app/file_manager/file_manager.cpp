...
static void file_maneger_process(AppController *sys, const ImuAction *action)
{
...
static void file_maneger_background_task(AppController *sys, const ImuAction *act_info)
{
...
static void file_maneger_message_handle(const char *from, const char *to, APP_MESSAGE_TYPE type, void *message,
                                        void *ext_info)
{
    switch (type) {
